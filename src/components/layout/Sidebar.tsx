...
export type View = 'dashboard' | 'stocks' | 'crypto' | 'cash' | 'assets' | 'income' | 'settings';
...
const settingsItem: { id: View; label: string; icon: ReactNode } = {
  id: 'settings',
  label: 'Settings',
  icon: (
    <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export default function Sidebar({ activeView, onNavigate }: SidebarProps) {
  return (
    <aside className="w-48 bg-[#F5F5F3] border-r border-gray-200 flex flex-col pt-12">
