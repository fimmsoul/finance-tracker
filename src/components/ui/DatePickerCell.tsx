    ...
    return (
      <>
        <span
          ...
          className={cn(
            'block w-full text-[13px] py-0.5 px-1 -mx-1 rounded cursor-pointer transition-colors duration-200 min-h-[1.5rem] flex items-center gap-1 outline-none focus:ring-1 focus:ring-[var(--color-primary)]/40',
            isEmpty && 'text-[var(--color-text-muted)]',
            open && 'bg-[var(--color-border-light)]',
            className,
          )}
        >
          <svg className="w-3 h-3 text-[var(--color-text-muted)] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
